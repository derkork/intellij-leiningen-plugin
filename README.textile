...
base, to ensure that the plugin will run on the Community Edition as well. You can then select the Run Leiningen Plugin
run configuration to test your changes. To build a deployable Jar file, select Build -> Prepare plugin-module
"leiningen-plugin" for deployment. This will create a Jar file that you can deploy into you IntelliJ plugins folder.
